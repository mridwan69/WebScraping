    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="pcoded-main-container">
								...
								<!-- Page-header start -->
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Suku Bunga Kartu Kredit</h5>
              ...
              $kodeHTML =  bacaHTML('https://www.bca.co.id/id/Individu/Sarana/Kurs-dan-Suku-Bunga/Suku-Bunga-Kartu-Kredit');
              $pecah = explode('<table class="table table-bordered table-striped table-hovered table-responsive">', $kodeHTML);
              
              
              echo '<br><b>Semua Jenis Kartu Kredit Konsumer BCA</b>';
              ...
              $paragraph222 = explode('</p>', $paragraph2[2]);
              echo $paragraph22[0]; echo '<br>';
              echo $paragraph222[0];

              echo '<br><br><b>Kartu BCA Smartcash</b>';
              $pecahLagi1 = explode('</table>', $pecah[2]);
              echo '<table class="table table-bordered">';
              echo $pecahLagi1[0];
              echo '</table>';
             
              $paragraph3 = explode('</p>', $paragraph2[3]);
              echo $paragraph3[0];
              $paragraph4 = explode('</p>', $paragraph2[4]);
              echo '<br>'.$paragraph4[0];


              echo '<br><br><b>Kartu Corporate</b> ';
              $pecahLagi2 = explode('</table>', $pecah[3]);
              echo '<table class="table table-bordered">';
              echo $pecahLagi2[0];
              echo '</table>';
          
              $paragraph5 = explode('</p>', $paragraph2[5]);
              echo $paragraph5[0];
              $paragraph6 = explode('</p>', $paragraph2[6]);
              echo '<br>'.$paragraph6[0];
