    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
								...
								<!-- Page-header start -->
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Kurs Forward</h5>
         ...
         <?php
                ...
                $kodeHTML =  bacaHTML('https://www.bca.co.id/individu/sarana/kurs-dan-suku-bunga/kurs-forward-dan-kalkulator');
                $pecah = explode('<table class="table table-bordered">', $kodeHTML);
